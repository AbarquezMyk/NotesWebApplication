...
import { Address as Address$1 } from './ChainId.js';
import { NativeScript as NativeScript$1 } from './Transaction.js';
...
declare function allOf(...addresses: NativeScript[]): NativeScript$1;
declare function anyOf(...addresses: NativeScript[]): NativeScript$1;
declare function atLeastNOfK(n: number, ...addresses: NativeScript[]): NativeScript$1;
declare function justAddress(address: string, networkId: NetworkId): NativeScript$1;
declare function before(slot: Slot): NativeScript$1;
declare function after(slot: Slot): NativeScript$1;
declare function address(ns: NativeScript, networkId: NetworkId): Address$1;

declare const nativescript_address: typeof address;
declare const nativescript_after: typeof after;
declare const nativescript_allOf: typeof allOf;
declare const nativescript_anyOf: typeof anyOf;
declare const nativescript_atLeastNOfK: typeof atLeastNOfK;
declare const nativescript_before: typeof before;
declare const nativescript_justAddress: typeof justAddress;
declare namespace nativescript {
  export { nativescript_address as address, nativescript_after as after, nativescript_allOf as allOf, nativescript_anyOf as anyOf, nativescript_atLeastNOfK as atLeastNOfK, nativescript_before as before, nativescript_justAddress as justAddress };
}

export { Address, AddressType, AssetId, AssetName, AuxiliaryData, Bip32PrivateKey, Bip32PrivateKeyHex, Bip32PublicKey, CborReader, CborReaderState, CborSet, CborWriter, Certificate, CertificateType, ConstrPlutusData, CostModel, type CostModels, Costmdls, Credential, type CredentialCore, CredentialType, Datum, DatumHash, DatumKind, Ed25519KeyHashHex, Ed25519PrivateExtendedKeyHex, Ed25519PrivateKey, Ed25519PrivateNormalKeyHex, Ed25519PublicKey, Ed25519PublicKeyHex, Ed25519Signature, Ed25519SignatureHex, type Evaluator, ExUnits, Hash, Hash28ByteBase16, Hash32ByteBase16, HashAsPubKeyHex, Metadata, Metadatum, MetadatumList, MetadatumMap, type MinFeeReferenceScripts, NativeScript, nativescript as NativeScripts, NetworkId, PaymentAddress, PlutusData, PlutusDataKind, PlutusLanguageVersion, PlutusList, PlutusMap, PlutusV1Script, PlutusV2Script, PlutusV3Script, PolicyId, PolicyIdToHash, PoolId, type Prettier, type ProtocolParameters, Redeemer, RedeemerPurpose, RedeemerTag, Redeemers, RewardAccount, RewardAddress, SLOT_CONFIG_NETWORK, Script, ScriptAll, ScriptAny, type ScriptHash, ScriptNOfK, ScriptPubkey, type SelectionPhase, Slot, type SlotConfig, StakeDelegation, type StakeDelegationCertificate, StakeDeregistration, StakeRegistration, TimelockExpiry, TimelockStart, type TokenMap, Transaction, TransactionBody, TransactionId, TransactionInput, type TransactionInputSet, TransactionMetadatumKind, TransactionOutput, TransactionUnspentOutput, type TransactionWitnessPlutusData, TransactionWitnessSet, TxCBOR, UTxOSelectionError, Value, VkeyWitness, addressFromBech32, addressFromCredential, addressFromCredentials, addressFromValidator, blake2b_224, blake2b_256, derivePublicKey, entropyToMnemonic, fromHex, generateMnemonic, getBurnAddress, getPaymentAddress, hardCodedProtocolParams, mnemonicToEntropy, prettify, setInConwayEra, sha2_256, sha3_256, signMessage, toHex };
