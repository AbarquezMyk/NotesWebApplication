 ...
 */
declare function sum(values: Value[]): Value;
/**
...
//#endregion
export { assetTypes, assets, empty, intersect, makeValue, merge, negate, negatives, positives, sub, sum, value_d_exports, zero };