import { __export, makeValue, value_d_exports } from "./value-CDNBnVcn.js";
import { Address, AssetName, AuxiliaryData, Costmdls, Credential, Datum, Ed25519KeyHashHex, Ed25519PublicKeyHex, Ed25519SignatureHex, Evaluator, Hash32ByteBase16, HexBlob, Metadata, NetworkId, PlutusData, PolicyId, PoolId, ProtocolParameters, Redeemers, RewardAccount, Script, Slot, Transaction, TransactionInput, TransactionOutput, TransactionUnspentOutput, TransactionWitnessSet, Value } from "@blaze-cardano/core";
...
interface UseCoinSelectionArgs {
 ...
 * @returns
 */
declare const stringifyBigint: typeof JSON.stringify;
/**
 ...
 * @returns {boolean}
 */
declare const isEqualUTxO: (self: TransactionUnspentOutput, that: TransactionUnspentOutput) => boolean;
/**
 ...
 * @returns {boolean}
 */
declare const isEqualInput: (self: TransactionInput, that: TransactionInput) => boolean;
/**
 ...
 * @returns {boolean}
 */
declare const isEqualOutput: (self: TransactionOutput, that: TransactionOutput) => boolean;
/**
 ...
 */
declare function computeScriptData(redeemers: Redeemers, datums: ReturnType<TransactionWitnessSet["plutusData"]>,
 ...
 */
declare const insertSorted: (arr: string[], el: string) => number;
/**
 ...
 */
declare const getAuxiliaryDataHash: (data: AuxiliaryData) => Hash32ByteBase16;
/**
 ...
 */
declare const assertPaymentsAddress: (address: Address) => never | void;
/**
 ...
 */
declare const assertLockAddress: (address: Address) => never | void;
/**
 ...
 */
declare const bigintMax: (a: bigint, b: bigint) => bigint;
/**
 ...
 */
declare const assertValidOutput: (output: TransactionOutput, coinsPerUtxoByte: number, maxValueSize: number) => void | never;
//#endregion
//#region src/coinSelectors/hvfSelector.d.ts
/**
...
//#endregion
//#region src/coinSelectors/micahsSelector.d.ts
/**
