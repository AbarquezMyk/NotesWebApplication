import { Address, AddressType, Bip32PrivateKey, Bip32PrivateKeyHex, Bip32PublicKey, Ed25519PrivateNormalKeyHex, HexBlob, NetworkId, RewardAddress, Transaction, TransactionId, TransactionUnspentOutput, TransactionWitnessSet, Value } from "@blaze-cardano/core";
 ...
 */
declare const WalletDetails: Wallet$1[];
//#endregion
//#region src/web.d.ts
/**
 * Wallet class that interacts with the WalletInterface.
 */
declare class WebWallet implements Wallet {
  private webWallet;
  /**
 ...
 */
declare class HotWallet implements Wallet {
  private provider;
  private signingKey;
...
//#endregion
//#region src/cold.d.ts
/**
 * Wallet class that interacts with the ColdWallet.
 */
declare class ColdWallet implements Wallet {
  private provider;
  readonly address: Address;
  readonly networkId: NetworkId;
  /**
...
//#endregion
export { CIP30DataSignature, CIP30Interface, ColdWallet, HotSingleWallet, HotWallet, Namespace, Wallet, WalletDetails, WebWallet };