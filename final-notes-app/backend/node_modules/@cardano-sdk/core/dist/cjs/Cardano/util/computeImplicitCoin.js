...
const Address = __importStar(require("../../Cardano/Address"));
...
const computeShellyDeposits = (depositParams, certificates, rewardAccounts) => {
    ...
    const poolIds = new Set(rewardAccounts.map((account) => Cardano.PoolId.fromKeyHash((0, crypto_1.Ed25519KeyHashHex)(Address.RewardAccount.toHash(account)))));
