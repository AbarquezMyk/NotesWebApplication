...
export default function Login({ onLogin }) {
  ...
  const EyeClosed = (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M17.94 17.94C16.23 19.01 14.19 19.64 12 19.64C6 19.64 2 12 2 12C3.24 9.71 4.97 7.77 7.06 6.35"
        stroke="#C69C6D"
        strokeWidth="2"
      />
      <path
        d="M12 5C18 5 22 12 22 12C21.46 12.96 20.84 13.85 20.17 14.64"
        stroke="#C69C6D"
        strokeWidth="2"
      />
      <circle cx="12" cy="12" r="3" stroke="#C69C6D" strokeWidth="2" />
